                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row w-100 d-flex justify-content-center">
                                <a href="{{route('admin.matalot.edit', $matalot->id)}}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Edit">
                                    <i class="la la-edit"></i>
                                </a>
                                <form method="POST" action="{{route('admin.matalot.destroy',$matalot->id)}}">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
