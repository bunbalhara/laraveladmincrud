    ...
    <div class="m-portlet m-portlet--mobile" m-portlet="true">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <a href="{{route('admin.coupon.create')}}" class="btn m-btn--square btn-outline-info btn-sm m-btn m-btn--custom m-1">
                    <span>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable table-center" id="datatable">
                ...
                @foreach($coupons as $coupon)
                    <tr>
                        ...
                        <td>{{$coupon->status}}</td>
                        <td>
                            <a href="{{route('admin.coupon.edit', $coupon->id)}}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Edit">
                                <i class="la la-edit"></i>
                            </a>
                            <a href="{{route('admin.coupon.destroy',$coupon->id)}}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">
