        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="javascript:void(0);" class="m-nav__link">
                    <span class="m-nav__link-text">Fileupload</span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="m-portlet m-portlet--mobile" m-portlet="true">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <a href="{{route('admin.fileupload.create')}}" class="btn m-btn--square btn-outline-info btn-sm m-btn m-btn--custom m-1">
                    <span>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable table-center" id="datatable">
                ...
                @foreach($fileuploads as $fileupload)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('admin.fileupload.edit', $fileupload->id)}}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Detail">
                                <i class="la la-edit"></i>
                            </a>
                            <a href="{{route('admin.fileupload.destroy',$fileupload->id)}}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">
